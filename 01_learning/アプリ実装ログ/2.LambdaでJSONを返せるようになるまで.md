...
- 「Lambda のコードは AWS 画面で直接書くもの」  
    という感覚があった（Node.js のイメージ）
...
- **C# のオブジェクトが自動で JSON になる**  
    と思っていた
    

### 実際に起きていること

- `APIGatewayProxyResponse` はただの C# クラス
